                    ...
                    <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6'>
                        <div className='rounded-[10px] mx-3 md:m-0 py-[30px] px-[30px] bg-white border border-[#E2E2E2] dark:bg-[#2d3a4f] dark:border-[#566279]'>
                            <div className='grid grid-cols-2 md:grid-cols-3 gap-4 '>
                                ...
                                <div className='bg-gradient-to-b from-[#008EFF]  rounded-[10px]'>
                                    <div className='bg-white m-[2px] rounded-[10px] p-[15px] text-center dark:bg-slate-700'>
                        ...
                        <div className='bg-white border border-[#E2E2E2] h-full rounded-[10px] mx-3 md:m-0 p-4 dark:bg-[#2d3a4f] dark:border-[#566279]'>
                            <div className=''>
                        ...
                        <div className='rounded-[10px] mx-3 md:m-0 py-[30px] px-[30px] bg-white border border-[#E2E2E2] dark:bg-[#2d3a4f] dark:border-[#566279]'>
                            <div className='grid grid-cols-2 md:grid-cols-3 gap-4 '>
                                <div className='bg-gradient-to-b from-[#DCBF26]  rounded-[10px]'>
                                    <div className='bg-white m-[2px] rounded-[10px] p-[15px] text-center dark:bg-slate-700'>
                                ...
                                <div className='bg-gradient-to-b from-[#61DAFB]  rounded-[10px]'>
                                    <div className='bg-white m-[2px] rounded-[10px] p-[15px] text-center dark:bg-slate-700'>
                                ...
                                <div className='bg-gradient-to-b from-[#E23237]  rounded-[10px]'>
                                    <div className='bg-white m-[2px] rounded-[10px] p-[15px] text-center dark:bg-slate-700'>
                                ...
                                <div className='bg-gradient-to-b from-[#60ECFF]  rounded-[10px]'>
                                    <div className='bg-white m-[2px] rounded-[10px] p-[15px] text-center dark:bg-slate-700'>
