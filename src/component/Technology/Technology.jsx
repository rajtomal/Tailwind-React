            ...
            <section className="bg-[url('./assets/about-bg.png')] bg-center bg-no-repeat bg-cover">
                <div className='lg:py-[70px] py-[50px] max-w-7xl mx-auto px-2'>
                    <div className='grid grid-cols-1 md:grid-cols-12 gap-6'>
                        <div className='md:col-span-4 rounded-[10px] mx-3 md:m-0 py-[30px] px-[30px] bg-white border border-[#E2E2E2] dark:bg-[#273346] dark:border-[#404E68]'>
                            <div className='grid grid-cols-12 md:grid-cols-12 gap-4 '>
                                <div className='md:col-span-4 col-span-6 bg-gradient-to-b from-[#0ACF83]  rounded-[10px]'>
                                    <div className='bg-white m-[2px] rounded-[10px] p-[15px] text-center dark:bg-[#273346]'>
                        ...
                        <div className='md:col-span-4 bg-white border border-[#E2E2E2] h-full rounded-[10px] mx-3 md:m-0 p-4 dark:bg-[#273346] dark:border-[#404E68]'>
                            <div className=''>
