        ...
        <>
            <section className="bg-[url('./assets/biography-bg.png')] bg-center bg-no-repeat bg-cover">
                <div className='lg:py-[70px] py-[50px] max-w-7xl mx-auto px-2'>
                    <h2 className='text-[#222831] text-[18px] font-semibold text-center'>Explore History</h2>
                    ...
                    <div className='grid grid-cols-1 md:grid-cols-12 gap-3 mt-5'>
                        <div className='md:col-span-6 rounded-[10px] mx-3 md:m-0 p-3 bg-white border border-[#E2E2E2]'>
                            ...
                            <div className='flex items-center justify-between px-[15px] py-[10px] rounded-[10px] mt-5 bg-[#E2E2E2]/20'>
                                <div className='flex items-center justify-between gap-4'>
                                    ...
                                    <div>
                                        <h4 className='text-[16px] font-semibold text-[#222831]'>Intellier Ltd.</h4>
                                        <p className='text-[16px] font-regular text-[#222831]'>Jr. Software Engineer</p>
                                    </div>
                                </div>
                                <div>
                            ...
                            <div className='flex items-center justify-between px-[15px] py-[10px] rounded-[10px] mt-5 bg-[#E2E2E2]/20'>
                                <div className='flex items-center justify-between gap-4'>
                                    ...
                                    <div>
                                        <h4 className='text-[16px] font-semibold text-[#222831]'>G-soft</h4>
                                        <p className='text-[16px] font-regular text-[#222831]'>Web Designer <span className='text-[12px]'>(Remote)</span></p>
                                    </div>
                                </div>
                                <div>
                                    <h4 className=''>Jan 2020 - Mar 2021</h4>
                                </div>
                            </div>
                        </div>
                        <div className='md:col-span-6 rounded-[10px] mx-3 md:m-0 p-3 bg-white border border-[#E2E2E2]'>
                            ...
                            <div className='flex items-center justify-between px-[15px] py-[10px] rounded-[10px] mt-5 bg-[#E2E2E2]/20'>
                                <div className='flex items-center justify-between gap-4'>
                                    ...
                                    <div>
                                        <h4 className='text-[16px] font-semibold text-[#222831]'>Sonargaon University</h4>
                                        <p className='text-[16px] font-regular text-[#222831]'>B.Sc. in CSE</p>
                                    </div>
                                </div>
                                <div>
                            ...
                            <div className='flex items-center justify-between px-[15px] py-[10px] rounded-[10px] mt-5 bg-[#E2E2E2]/20'>
                                <div className='flex items-center justify-between gap-4'>
                                    ...
                                    <div>
                                        <h4 className='text-[16px] font-semibold text-[#222831]'>Rangpur Polytechnic Institute</h4>
                                        <p className='text-[16px] font-regular text-[#222831]'>Diploma in Engineering, (CSE)</p>
                                    </div>
                                </div>
                                <div>
                            ...
                            <div className='flex items-center justify-between px-[15px] py-[10px] rounded-[10px] mt-5 bg-[#E2E2E2]/20'>
                                <div className='flex items-center justify-between gap-4'>
                                    ...
                                    <div>
                                        <h4 className='text-[16px] font-semibold text-[#222831]'>Sukhanpukur High School</h4>
                                        <p className='text-[16px] font-regular text-[#222831]'>Secondary School Certificate (SSC)</p>
                                    </div>
                                </div>
                                <div>
                                    <h4 className=''>Feb 2017</h4>
                                </div>
                            </div>
                        </div>
                    </div>
