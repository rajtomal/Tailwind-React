                ...
                <div className='lg:py-[70px] py-[50px] max-w-7xl mx-auto px-2'>
                    ...
                    >
                        <div className='grid grid-cols-1 md:grid-cols-12 gap-3 '>
                            <SwiperSlide>
                                <div className='md:col-span-4 rounded-[10px] mx-3 md:m-0 p-3 bg-white border border-[#E2E2E2] h-[315px] md:h-[250px] flex flex-col justify-between dark:bg-[#273346] dark:border-[#566279]'>
                                    <div className='px-2'>
