        ...
        <>
            <section className="dark:bg-[url('./assets/bg-img/satisfaction-bg-dark.svg')] bg-[url('./assets/bg-img/satisfaction-bg-light.svg')] bg-center bg-no-repeat bg-cover">
                <div className='lg:py-[70px] py-[30px] max-w-7xl mx-auto px-2'>
                    <h2 className='text-[#222831] lg:text-[18px] text-[16px] font-semibold dark:text-white'>Satisfaction Quotes</h2>
                    <h1 className='custom-header-stroke text-transparent lg:text-[28px] text-[22px] font-bold uppercase tracking-wider'>Satisfaction Quotes</h1>
                    <Swiper
                        spaceBetween={25}
                    ...
                    >
                        <div className='grid grid-cols-1 md:grid-cols-12 gap-3 '>
                            <SwiperSlide>
                                <div className='md:col-span-4 rounded-[10px] mx-3 md:m-0 p-3 bg-white border border-[#E2E2E2] h-[315px] md:h-[265px] lg:h-[250px] flex flex-col justify-between dark:bg-[#273346] dark:border-[#566279]'>
                                    <div className='px-2'>
                                    ...
                                    <div className='flex justify-between items-center pt-3 mt-4 px-2 border-t border-[#E2E2E2] dark:border-[#566279]'>
                                        <div>
