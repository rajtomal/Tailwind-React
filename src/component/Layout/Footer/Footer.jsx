            ...
            <section className="dark:bg-none bg-[url('./assets/footer-bg.png')] bg-center bg-no-repeat bg-cover">
                <div className='lg:pt-[70px] pt-[50px] max-w-7xl mx-auto px-2'>
                    ...
                    <div className='flex justify-center  gap-4 pb-[30px]'>
                        <div className='rounded-[10px] mx-2 md:m-0  border border-[#E2E2E2] rounded-[10px] dark:bg-[#273346] dark:border-[#404E68]'>
                            <div className=' rounded-[10px] p-[10px] text-center'>
